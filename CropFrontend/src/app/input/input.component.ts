...
export class InputComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.http.get<String[]>('http://localhost:8085/getstate')
    .subscribe
    (
        data =>
        {
 ...
 public changestate(i : Event)
 {
   ...
   {
      this.http.get<String[]>('http://localhost:8085/getdistrict/' + this.backservice.crop.State_Name)
      .subscribe
      (
          data =>
          {
 ...
 public changedistrict(i : any)
 {
      ...
      {
        this.http.get<String[]>('http://localhost:8085/getcrop/'+ this.backservice.crop.State_Name + '/' + this.backservice.crop.District_Name)
        .subscribe
        (
            data =>
            {
